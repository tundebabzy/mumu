...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerLogs.n_user'
        db.add_column(u'quizzer_answerlogs', 'n_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.RegistrationProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerLogs.n_user'
        db.delete_column(u'quizzer_answerlogs', 'n_user_id')
    ...
    models = {
        ...
        u'quizzer.answerlogs': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'n_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration.RegistrationProfile']", 'null': 'True', 'blank': 'True'}),
