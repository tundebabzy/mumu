...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for question in all_question_objects:
            optionexplanation_obj = question.optionexplanation_set.all()
            questionreference_obj = question.questionreference_set.all()

            if optionexplanation_obj:
                question.explanation = optionexplanation_obj[0].explanation
            else:
                question.explanation = ''
            if questionreference_obj:
                question.reference = questionreference_obj[0].source
            else:
                question.reference = ''
            question.save()
