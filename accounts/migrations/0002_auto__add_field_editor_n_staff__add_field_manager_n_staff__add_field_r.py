...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'accounts_editor', 'n_staff',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='registration_profile_editor', null=True, to=orm['registration.RegistrationProfile']),
                      keep_default=False)

        # Adding field 'Manager.n_staff'
        db.add_column(u'accounts_manager', 'n_staff',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='registration_profile_manager', null=True, to=orm['registration.RegistrationProfile']),
                      keep_default=False)

        # Adding field 'Researcher.n_staff'
        db.add_column(u'accounts_researcher', 'n_staff',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='registration_profile_researcher', null=True, to=orm['registration.RegistrationProfile']),
                      keep_default=False)
