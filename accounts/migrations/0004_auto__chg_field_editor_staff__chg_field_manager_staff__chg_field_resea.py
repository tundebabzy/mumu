...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Editor.staff'
        db.alter_column(u'accounts_editor', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.QuizzerProfile']))

        # Changing field 'Manager.staff'
        db.alter_column(u'accounts_manager', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.QuizzerProfile']))

        # Changing field 'Researcher.staff'
        db.alter_column(u'accounts_researcher', 'staff_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.QuizzerProfile']))
